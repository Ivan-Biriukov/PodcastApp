...
final class PhotoPickerView: UIView {
    ...
    @objc private func didTapTrashcan() {
    ...
    private func setupView() {
        backgroundColor = .init(rgb: 0xFEFEFE)
        ...
        NSLayoutConstraint.activate([
            ...
            cameraView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: 1/6),
            
            stack.topAnchor.constraint(equalTo: separator.bottomAnchor, constant: 20),
